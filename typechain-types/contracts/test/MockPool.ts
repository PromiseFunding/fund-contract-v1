...
export interface MockPoolInterface extends utils.Interface {
  functions: {
    ...
    "approveTransfer(address,address)": FunctionFragment;
    ...
    "i_aaveAssetAddress()": FunctionFragment;
    ...
    "setAssetAddress()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "i_aaveAssetAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MockPool extends BaseContract {
  ...
  functions: {
    ...
    i_aaveAssetAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    setAssetAddress(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    i_aaveAssetAddress(overrides?: CallOverrides): Promise<BigNumber>;
